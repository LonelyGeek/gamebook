<?php
     ...
     foreach($busca->selecionarProgresso($id, $id_mat) as $linha){ 
        ...
        $resposta[1] = $_POST['pergunta1'];

        $resposta[2] = $_POST['pergunta2']; 

        $resposta[3] = $_POST['pergunta3']; 

        $resposta[4] = $_POST['pergunta4']; 

        $resposta[5] = $_POST['pergunta5']; 
                                         ...
                                         foreach($busca->selecionarExercicio($id_mat) as $linha){    // automatizar o ID
                                ...
                                <div class="portlet box">
                                   ...
                                   echo "<h1>Nota: $nota </h1>" ;
                                       ...
                                       if($nota >= 6){
                                             ...
                                             echo "<h3>Parabéns, você passou no exercício</h3>";
