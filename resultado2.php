...
$_SESSION['q3'] = $_POST['3'];
  ...
  $id_top = "1"; //$_GET['idmat'];
    ...
    foreach($busca->selecionarPontos($id) as $linha){ 
     ...
     foreach($busca->selecionarProgresso($id, $id_mat) as $linha){ 
             $progresso = $linha['progresso'];
     }

  

        $resposta[1] = $_SESSION['q1'];

        $resposta[2] = $_SESSION['q2']; 

        $resposta[3] = $_SESSION['q3']; 
                                         ...
                                         foreach($busca->selecionarExercicio3($id_top) as $linha){    // automatizar o ID


                                            if($resposta[$i] == $linha['altcerta']){

                                            	//echo "resposta certa";
                                            	$estrela++;
                                                $nota = $nota + 3.33;
                                                $updates->alterarNota($id, $nota, $id_mat);
                                                $updates->alterarPontos($id, $pontos, $pontosGanho);
                                                $updates->alterarProgresso($id, $progresso, $id_mat);
                                            }else{
                        ...
                        <div class="row mbl">
                            <div class="col-lg-12">
                                <div class="portlet box">
                                   ...
                                   <?php  // mostrar respostas certas


                                   echo "<center>";
                                   echo "<h1>$estrela ESTRELAS</h1>";

                                   if($estrela == 1){

                                   echo " <img src='img/estrela.png' width='100px' > "; 
                                   echo " <img src='img/estrelaapagada.png' width='100px' > "; 
                                   echo " <img src='img/estrelaapagada.png' width='100px' > "; 
                                     ...
                                     echo " <img src='img/estrela.png' width='100px' > "; 
                                       ...
                                       if($estrela >= 2){
                                             ...
                                             <h3>Parabéns, você passou no exercício</h3>
                                             ...
                                             echo "<h3>Pontos: $pontos  <font color='green'><b>(+100)</b></font></h3>";
                                            


                                       }else{
                                            
                                             echo "<h3>Você não passou no exercício, refaça o exercício</h3>";
                                   ...
                                   ?>
                                     ...
                                     <a href="painel.php" class="btn btn-success btn-lg btn3d"><font size="4">Continuar</font></a>
                                     </center>
