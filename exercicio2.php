                ...
                <div class="page-content">
                    <div id="tab-general">
                        ...
                        <div class="row mbl">
                           ...
                           <?php foreach($busca->selecionarExercicio2($idTop, 2) as $linha){   ?>
                                    <center>
                            ...
                            <form method="post" action="exercicio3.php?id=<?php echo $idTop ?>&idmat=<?php echo $idmat ?>&top=<?php echo $nomeTop ?>">

                                <div class="col-sm-3 widget_1_box">
                                   <input class="btn btn-info btn-block btn3d" type="submit" name="2" value="<?php echo $linha['alt1']; ?>" />
                                  </div>
                                  <div class="col-sm-3 widget_1_box">
                                    <input class="btn btn-success btn-block btn3d" type="submit" name="2" value="<?php echo $linha['alt2']; ?>" />
                                  </div>
                                  <div class="col-sm-3 widget_1_box">
                                    <input class="btn btn-warning btn-block btn3d" type="submit" name="2" value="<?php echo $linha['alt3']; ?>" />
                                   </div>
                                  <div class="col-sm-3 widget_1_box">
                                    <input class="btn btn-primary btn-block btn3d" type="submit" name="2" value="<?php echo $linha['alt4']; ?>" />
                                  </div>
                                <?php } ?> 
                            </form>
