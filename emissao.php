...
<body>
    <div>
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                  ...
                  <li><a href="emateria.php"><i class="fa fa-edit fa-fw">
                     ...
                     <li  class="active"><a href="emissao.php"><i class="fa fa-edit fa-fw">
                        <div class="icon-bg bg-pink"></div>
        ...
        <div class="col-sm-3">
            <a href="#" class="btn btn-primary pull-right h2"><b>ADICIONAR NOVA MISSÃO</b></a>
        </div>
    ...
    <div class="table-responsive col-md-12">
        <table class="table table-striped" cellspacing="0" cellpadding="0">
            ...
            <?php foreach($busca->selecionarMissao(1) as $linha){   ?>
                <tr>
