...
<body>
            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Editar Matéria</li>
                    </ol>
                    <div class="clearfix">
                    </div>
                </div>
  ...
  <form action="adicionandomateria.php" method="POST" >
    ...
    <div class="row">
      <div class="form-group col-md-6">
        <label name="nomemat"><b>DIGITE O NOME DA MATÉRIA</b></label>
        <input id="nomemat" name="nomemat" type="text"  class="form-control input-md" required="">
      </div>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <a href="emateria.php" class="btn btn-info btn-lg">Voltar</a>
      </div>
    </div>
