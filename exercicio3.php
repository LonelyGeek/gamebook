                        ...
                        <div class="row mbl">
                            <div class="col-lg-12">
                                <div class="portlet box">
                                   ...
                                   <?php foreach($busca->selecionarExercicio2($idTop, 3) as $linha){   ?>
                                    <center>
                            ...
                            <form method="post" action="resultado2.php?idmat=<?php echo $idmat ?>">

                                 <div class="col-sm-3 widget_1_box">
                                   <input class="btn btn-info btn-block btn3d" type="submit" name="3" value="<?php echo $linha['alt1']; ?>" />
                                  </div>
                                  <div class="col-sm-3 widget_1_box">
                                    <input class="btn btn-success btn-block btn3d" type="submit" name="3" value="<?php echo $linha['alt2']; ?>" />
                                  </div>
                                  <div class="col-sm-3 widget_1_box">
                                    <input class="btn btn-warning btn-block btn3d" type="submit" name="3" value="<?php echo $linha['alt3']; ?>" />
                                   </div>
                                  <div class="col-sm-3 widget_1_box">
                                    <input class="btn btn-primary btn-block btn3d" type="submit" name="3" value="<?php echo $linha['alt4']; ?>" />
                                  </div>
                                <?php } ?> 
                            </form>
