    ...
    <div>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <?php foreach($busca->selecionarMateria($id) as $linha){   ?>

            <div class="widget_1">

          
           <center>
                     <a href="topicos.php?id=<?php echo $linha['id_mat']?>&materia=<?php  echo $linha['nome'] ?>&idmat=<?php  echo $linha['id_mat'] ?>">
                         <div class="col-sm-3 widget_1_box">
                             <button type="button" class="btn btn-info btn-lg btn3d">
                              <div class="panel-body">
                                <h4><b> <?php  echo $linha['nome'] ?> </b> </h4>
                                 
                    <div class="progress">
                           <div class="progress-bar progress-bar-danger progress-bar-striped" role="progressbar"
                            aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width:<?php  echo $linha['progresso'] ?>%">
    
                           </div>
                    </div>
                                   <span><b><?php  echo $linha['progresso'] ?>% completado</b></span>
                              </div>
                            </button>
                         </div>
                     </a></center>
