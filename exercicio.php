        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    <div class="page-header pull-left">
                        <div class="page-title">
                            Exercício / <?php echo $nomeTop ?></div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active"><?php echo $nomeTop ?>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                        <li class="hidden"><a href="painel.php">Painel</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                        <li class="active">Exercicio</li>
                    </ol>
                    <div class="clearfix">
                    </div>
                </div>
                ...
                <div class="page-content">
                    <div id="tab-general">
                        ...
                        <div class="row mbl">
                           ...
                           <?php foreach($busca->selecionarExercicio2($idTop, 1) as $linha){   ?>
                                    <center>
                                    <img src="<?php echo $linha['tirinha']; ?>" >
                                    </center>
                                    <br>

                                    <div class="note note-success"><h4 class="box-heading">Questão <?php echo $linha['questao']; ?> </h4>

                                            <p><h3><?php echo $linha['pergunta']; ?></h3></p> 
                                    </div>

                         
                            <form method="post" action="exercicio2.php?id=<?php echo $idTop ?>&idmat=<?php echo $idmat ?>&top=<?php echo $nomeTop ?>">

                                 <div class="col-sm-3 widget_1_box">
                                   <input class="btn btn-info btn-block btn3d" type="submit" name="1" value="<?php echo $linha['alt1']; ?>" />
                                  </div>
                                  <div class="col-sm-3 widget_1_box">
                                    <input class="btn btn-success btn-block btn3d" type="submit" name="1" value="<?php echo $linha['alt2']; ?>" />
                                  </div>
                                  <div class="col-sm-3 widget_1_box">
                                    <input class="btn btn-warning btn-block btn3d" type="submit" name="1" value="<?php echo $linha['alt3']; ?>" />
                                   </div>
                                  <div class="col-sm-3 widget_1_box">
                                    <input class="btn btn-primary btn-block btn3d" type="submit" name="1" value="<?php echo $linha['alt4']; ?>" />
                                  </div>
                                <?php } ?> 
                            </form>
                ...
                <div id="footer">
                        ...
                        <font color="#848181">2016 - Gamebook , Versão 1.0</font>
                </div>
                <!--END FOOTER-->
            </div>
            <!--END PAGE WRAPPER-->
