...
<body>
            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li><a href="perfil.php">Perfil</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
  ...
  <form class="form-horizontal" action="editandoperfil.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data">
   <div class="col-md-6">
  <b>Apelido:</b><br>
  <input id="apelido" name="apelido" type="text" value="<?php echo $apelido ?>" class="form-control input-md" required="">
  </div>


  <div class="col-md-6">
  <b>Nome:</b><br>
  <input id="nome" name="nome" type="text" value="<?php echo $nome ?>" class="form-control input-md" required="">
  </div>
  ...
  <input id="anonasc" name="anonasc" type="text" value="<?php echo $anonasc ?>" class="form-control input-md" required="">
  </div>

  <div class="col-md-6">
  <br>
  <b>Cidade:</b>
  <input id="cidade" name="cidade" type="text" value="<?php echo $cidade ?>" class="form-control input-md" required="">
  </div>

  <div class="col-md-6">
  <br>
  <b>Estado:</b>
  <input id="estado" name="estado" type="text" value="<?php echo $estado ?>" class="form-control input-md" required="">
  </div>

  <div class="col-md-6">
  <br>
  <b>Senha:</b>
  <input id="estado" name="senha" type="password" value="<?php echo $senha ?>" class="form-control input-md" required="">
  </div>

  <div class="col-md-12">
  <br>
  <b>Imagem do perfil:</b>
  <input id="filebutton" name="imagem" class="input-file" type="file" required="">
  </div>
   
  <div class="col-md-5">
  <br>
  <button id="editar" name="editar" class="btn btn-success btn-lg"><b>SALVAR</b></button>
  </div>
