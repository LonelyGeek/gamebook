                            ...
                            <div class="col-lg-12">
                                <div class="portlet box">
                                    ...
                                    <div class="portlet-body">
                                     ...
                                     <img height="140" width="150" src="img/<?php echo $imagem?>" alt=""/><br><br>
                  <?php
                        echo "
                        ...
                        <b>Apelido:</b> $apelido <br>
                              ...
                              <b>Ano de Nascimento:</b> $anonasc <br>
                              <b>Nível:</b> $nivel <br>
                              <b>Pontos:</b> $pontos <br> 

                        </font>";
                  ?>

                  <br>
                  <a href="editarperfil.php" class="btn btn-info btn-lg">
                          <b> Editar Perfil </b>
                   </a>
