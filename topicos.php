                        ...
                        <div class="row mbl">
                            <div class="col-lg-12">
                                <div class="portlet box">
                                  ...
                                  <h2><?php echo $nomeMat;   ?></h2><br>     
                                         
                <?php foreach($busca->selecionarTopico($idmat) as $linha){   ?>
                         ...
                         <div class="col-sm-3 widget_1_box">
                                   ...
                                   <a href="topico.php?top=<?php echo $linha['nome']; ?>&id=<?php echo $linha['id']; ?>&idmat=<?php echo $idmat?>" class="btn btn-success btn-block btn3d"><font size="5"><?php echo $linha['nome']; ?></font></a>
