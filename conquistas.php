        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li class="active"><a href="conquistas.php"><i class="fa fa-certificate fa-fw">
                            ...
                            <div class="col-lg-12">
                                <div class="portlet box">
                                    ...
                                    <div class="portlet-body">
                                               ...
                                               <div class="col-sm-3 widget_1_box"><center><br>
                                               <img src="img/Novato.png" width="170px" height="170px"></center>
                                               </div>

                                               <div class="col-sm-3 widget_1_box"><center><br>
                                               <img src="img/Aprendiz1.png" width="175px" height="175px"></center>
                                               </div>

                                               <div class="col-sm-3 widget_1_box">
                                               <center>
                                               <img src="img/Nerd1.png" width="180px" height="191px"></center>
                                               </div>


                                               <div class="col-sm-3 widget_1_box"><center>
                                               <img src="img/Graduado2.png" width="180px" height="190px"></center>
                                               </div>
