<?php
     ...
     foreach($busca->selecionarPontos($id) as $linha){ 
             $pontos = $linha['pontos'];
     }
        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li class="active"><a href="administrativo.php"><i class="fa fa-home fa-fw">
                        <div class="icon-bg bg-orange"></div>
                    </i><span class="menu-title">Painel</span></a></li>
                    
                    <li><a href="emateria.php"><i class="fa fa-edit fa-fw">
            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        <li><i class="fa fa-home"></i>&nbsp;<a href="index.php">Index</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                              ...
                              <div class="col-lg-8">
                                <div class="portlet box">
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <a href="emateria.php"><button type="button" class="btn btn-success btn-block btn3d"><b><font size="5">MATÉRIAS</font></b></button></a>  <hr>

                                        <a href="etopico.php"><button type="button" class="btn btn-info btn-block btn3d"><b><font size="5">TÓPICOS</font></b></button></a> <hr>

                                       

                                        <a href="emissao.php"><button type="button" class="btn btn-primary btn-block btn3d"><b><font size="5">MISSÕES</font></b></button></a> <hr>

                                         <a href="#"><button type="button" class="btn btn-default btn-block btn3d"><b><font size="5">EXERCÍCIOS</font></b></button></a> <hr>

                                        <a href="#"><button type="button" class="btn btn-default btn-block btn3d"><b><font size="5">EMBLEMAS</font></b></button></a> 
                                ...
                                <div class="portlet box">
                                    ...
                                    <div class="portlet-body">
                                        <ul class="list-unstyled">
                                         ...
                                         <?php
                                               $i=0; 
                                               foreach($busca->selecionarEstudante() as $linha){ 
                                               if ($i==7) break ;
                                          ?>      

                                          <li><b><img height="35" width="35" src="img/<?php echo $linha['imagem']?> " alt="" class=" img-circle"/><font color="#233140" size="3"><?php echo " ".$linha['apelido'] ?></font><div class="text-success pull-right"><font size="3"><?php echo $linha['pontos'] ?> Pontos</font></div></b></li><hr>
