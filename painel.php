        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li class="active"><a href="painel.php"><i class="fa fa-home fa-fw">
                        ...
                        <div class="row mbl">
                            <div class="col-lg-4">
                                <div class="portlet box">
                                    ...
                                    <?php
                                            ...
                                            foreach($busca->selecionarMissao($id) as $linha){ 
                                            if ($i==4) break ;
                                    ...
                                    <div class="note note-<?php echo $res ?>"><h4 class="box-heading"><?php  echo $linha['objetivo'] ?></h4>

                                            <p>Recompensa: <?php  echo $linha['pontos'] ?> pontos </p>
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <div class="portlet box">
                                    ...
                                    <div class="portlet-body">
                                        <center><div class="alert alert-info"><font size="5"><strong>Nível:</strong> <?php echo $nivel ?> <strong>Pontos:</strong> <?php echo $pontos ?></div> </font>

                                        <a href="materias.php"><button type="button" class="btn btn-success btn-block btn3d"><b><font size="6">ESTUDAR</font></b></button></a>  <hr>

                                       <img src="img/Novato.png" height="220" width="250"/>
