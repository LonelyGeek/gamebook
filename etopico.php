...
<body>
    <div>
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                  ...
                  <li><a href="emateria.php"><i class="fa fa-edit fa-fw">
                     ...
                     <li class="active"><a href="etopico.php"><i class="fa fa-edit fa-fw">
                        <div class="icon-bg bg-pink"></div>
                     ...
                     <li><a href="eemblema.php"><i class="fa fa-edit fa-fw">
                        <div class="icon-bg bg-pink"></div>
        ...
        <div class="col-sm-3">
            <a href="#" class="btn btn-primary pull-right h2"><b>ADICIONAR NOVO TÓPICO</b></a>
        </div>
    ...
    <div class="table-responsive col-md-12">
        <table class="table table-striped" cellspacing="0" cellpadding="0">
            ...
            <?php foreach($busca->selecionarTopico3() as $linha){   ?>
                <tr>
                    <td><?php  echo $linha['id'] ?> </td>
                    <td><?php  echo $linha['nome'] ?> </td>
                    
                    <td><?php  if( $linha['id_mat'] == 1){ echo "Português";}
                               else if( $linha['id_mat'] == 2){ echo "Matemática";}
                               else if( $linha['id_mat'] == 3){ echo "Geografica";}
                               else if( $linha['id_mat'] == 4){ echo "História";}  ?> </td>
                   
                    <td class="actions">
                        <a class="btn btn-success " href="#">Visualizar</a>
